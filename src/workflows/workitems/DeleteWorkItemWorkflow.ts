...
export default class DeleteWorkItemWorkflow {
  ...
  public async execute() {
    ...
    SFPLogger.log(
      `  Switching to default tracking branch ${COLOR_KEY_VALUE(
        this.workItem.trackingBranch
      )}`
    );
    ...
    let deleteOrgWorkflow = new DeleteOrgWorkflow(
      this.sfpProjectConfig,
      this.workItem.defaultDevOrg
    );
